# Article Kitchen Sink

## This article demonstrates the styling when the `sl-prose` class is added to a container. It is an adaptation of the Tailwind CSS Typography plugin, adjusted to fit the Stoplight Design System architecture.
...
It adds a new `sl-prose` class that you can slap on any block of vanilla HTML content and turn it into a beautiful,
well-formatted document:

```html
<article class="sl-prose">
